...
log using logfiles\d500_car_000_icd9, replace

**  GENERAL DO-FILE COMMENTS
**  program:      d500_car_000_icd9.do
**  project:      Preparing Caribbean mortality data: for population ageing analysis
**  author:       HAMBLETON \ 28-SEP-2015
**  task:         Preparing Caribbean mortality rate dataset: for population ageing analysis
...
** ICD9
insheet using "C:\statistics\analysis\a000\15_who_md\versions\version04\data\Morticd9\Morticd9.txt", clear
...
** Only interested in 1999-2001 in the ICD9 dataset
** Last year in ICD9 dataset is 2000
keep if year>=1990
...
** Save the file
sort cid year
save "data\input\who_md\pop_aging\carib_icd9", replace
