...
#delimit ;
	graph twoway 
		...
		/// non CARICOM
		(bar inc2001 cid2001 if non_car==1 , horizontal lc("91 146 229") lw(0.001) fc("91 146 229") )
		...
		xscale(lw(vthin)) xtitle("", margin(t=3) size(2.5)) 
		xmtick(`tick2')
...
** THE GRAPHIC. PART ONE. 2009-2011. USUAL COLOR
#delimit ;
	graph twoway 
		/// USA African-American
		...
		/// CARICOM
		(bar inc2011 cid2011 if car==1 , horizontal lc("91 146 229") lw(0.001) fc("91 146 229") )
		/// non CARICOM
		(bar inc2011 cid2011 if non_car==1 , horizontal lc("153 130 180") lw(0.001) fc("153 130 180") )
		,
		plotregion(c(gs16) ic(gs16) ilw(thin) lw(thin)) 
		graphregion(color(gs16) ic(gs16) ilw(thin) lw(thin)) 
		ysize(6)
...
** This generates "r(levels)" for use as labelling on Y-AXIS
levelsof cid2011
** HIGHLIGHT BARBADOS and ANTIGUA
#delimit ;
	graph twoway 
		...
		/// Antigua
		(bar inc2001 cid2001 if cid==2010 , horizontal lc(red*0.25) lw(0.001) fc(red*0.25) )
		(bar inc2011 cid2001 if cid==2010 , horizontal lc(red) lw(0.001) fc(red) )
