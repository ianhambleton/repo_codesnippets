...
#delimit ;
	graph twoway 
		...
		/// Caribbean
		(bar inc2001 cid2001 if cid>100 , horizontal lc("91 146 229") lw(0.001) fc("91 146 229") )
		(line cid2001 usmean2001           , lp("l") lc(gs10) lw(1))
		(line cid2001 carmean2001          , lp("l") lc("91 146 229") lw(1))
		,
...
#delimit ;
	graph twoway 
		...
		/// USA African-American
		(bar inc2001 cid2011 if race==1 , horizontal lc(gs13) lw(0.001) fc(gs13))
		(bar inc2011 cid2011 if race==1 , horizontal lc(gs7) lw(0.001) fc(gs7))

		/// USA White-American
		(bar inc2001 cid2001 if race==2 , horizontal lc(gs13) lw(0.001) fc(gs13))

		/// Caribbean
		(bar inc2001 cid2001 if cid>100 , horizontal lc("176 203 242") lw(0.001) fc("176 203 242") )
		(bar inc2011 cid2011 if cid>100 , horizontal lc("91 146 229") lw(0.001) fc("91 146 229") )

		(bar inc2011 cid2011 if race==2 , horizontal lc(gs7) lw(0.001) fc(gs7))
...
#delimit ;
	graph twoway 
		...
		/// Caribbean
		(bar inc2001 cid2001 if cid>100 , horizontal lc("176 203 242") lw(0.001) fc("176 203 242") )
		(bar inc2001 cid2001 if cid==2300 , horizontal lc(red*0.25) lw(0.001) fc(red*0.25) )
		(bar inc2011 cid2011 if cid>100 , horizontal lc("91 146 229") lw(0.001) fc("91 146 229") )
		(bar inc2011 cid2011 if cid==2300 , horizontal lc(red) lw(0.001) fc(red*0.75) )
...
#delimit ;
	graph twoway 
		...
		(bar inc2011 cid2011 if race==1 , horizontal lc(gs7) lw(0.001) fc(gs7))
		/// USA White-American
		(bar inc2001 cid2011 if race==2 , horizontal lc(gs13) lw(0.001) fc(gs13))
		(bar inc2011 cid2011 if race==2 , horizontal lc(gs7) lw(0.001) fc(gs7))
		/// Caribbean
		(bar inc2001 cid2001 if cid>100 , horizontal lc("176 203 242") lw(0.001) fc("176 203 242") )
		(bar inc2001 cid2001 if cid==2045 , horizontal lc(red*0.25) lw(0.001) fc(red*0.25) )
		(bar inc2011 cid2011 if cid>100 , horizontal lc("91 146 229") lw(0.001) fc("91 146 229") )
		(bar inc2011 cid2011 if cid==2045 , horizontal lc(red) lw(0.001) fc(red*0.75) )
...
#delimit ;
	graph twoway 
		...
		(bar inc2011 cid2011 if cid>100 , horizontal lc("91 146 229") lw(0.001) fc("91 146 229") )
		(bar inc2011 cid2011 if cid==2440 , horizontal lc(red) lw(0.001) fc(red*0.75) )
...
#delimit ;
	graph twoway 
		...
		(bar inc2011 cid2011 if cid>100 , horizontal lc("91 146 229") lw(0.001) fc("91 146 229") )
		(bar inc2011 cid2011 if cid==2040 , horizontal lc(red) lw(0.001) fc(red*0.75) )
