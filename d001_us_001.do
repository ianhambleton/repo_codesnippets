...
log using logfiles\d001_us1999_001, replace

**  GENERAL DO-FILE COMMENTS
**  program:      d001_us1999_001.do
...
** ************************************************************************************************
insheet using "C:\statistics\analysis\a054\versions\version05\data\input\wonder_2015\usa_level`folder1'\wonder`m'_usa_race_20150823.txt", tab clear
...
** ************************************************************************************************
insheet using "C:\statistics\analysis\a054\versions\version05\data\input\wonder_2015\usa_level`folder1'\wonder`m'_usa_20150823.txt", tab clear
...
** ************************************************************************************************
insheet using "C:\statistics\analysis\a054\versions\version05\data\input\wonder_2015\state_level`folder1'\wonder`m'_state_race_20150823.txt", tab clear
...
** ************************************************************************************************
insheet using "C:\statistics\analysis\a054\versions\version05\data\input\wonder_2015\state_level`folder1'\wonder`m'_state_race_both_20150823.txt", tab clear
...
** ************************************************************************************************
insheet using "C:\statistics\analysis\a054\versions\version05\data\input\wonder_2015\state_level`folder1'\wonder`m'_state_20150823.txt", tab clear
