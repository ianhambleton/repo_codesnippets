...
keep if decade==2 & sex==2 & cod==4 & arange==3 & dataset==28
keep if cid==2010
rename cid cid1
decode cid1, gen(cid)
...
spmap 	i using "C:\ado\personal\map_coordinates\atg1_coords", moc(gs14) mfc(gs14)
		...
		fcolor(Blues2) clmethod(eqint) eirange(42 136) legstyle(3) ndf(gs10) ndo(gs13) 
...
* Shapefile from  http://www.gadm.org/country
shp2dta using "C:\ado\personal\shapefiles\caribbean\guadeloupe\GLP_adm1.shp", ///
        data(C:\ado\personal\map_coordinates\glp1_database) coor(C:\ado\personal\map_coordinates\glp1_coords) replace

** USE the converted database file
use C:\ado\personal\map_coordinates\glp1_database, replace
tempfile glp1_database
save `glp1_database', replace
** Prepare adatabase file for merging with Mortality rates 
rename NAME_0 cid
rename NAME_1 district
gen sabbr = ISO
keep cid district sabbr _ID 
order cid district sabbr _ID
replace cid = "Guadeloupe"
save C:\ado\personal\map_coordinates\glp1_database_clean, replace

** Merge CLEAN DATABASE file with mortality rates by states
use `car_map_001', clear
keep if decade==2 & sex==2 & cod==4 & arange==3 & dataset==34
keep if cid==2240
rename cid cid1
decode cid1, gen(cid)
merge m:m cid using "C:\ado\personal\map_coordinates\glp1_database_clean"
drop if _merge==1
drop _merge
tempfile basemap
save `basemap', replace
...
** GLP. MALE. CVD-DIABETES. 0-64 (1999-2001)
#delimit ;
spmap 	i using "C:\ado\personal\map_coordinates\glp1_coords", moc(gs14) mfc(gs14)
		id(_ID) oc(gs13 gs13 gs13 gs13 gs13 gs13 )
		title("", size(7.5) pos(12) ring(0))
		fcolor(Blues2) clmethod(eqint) eirange(42 136) legstyle(3) ndf(gs10) ndo(gs13) 
		legend(off ring(0) position(5) bm(l=5 r=2 t=5) size(7) symy(7) symx(7)) 
...
* Shapefile from  http://www.gadm.org/country
shp2dta using "C:\ado\personal\shapefiles\caribbean\martinique\MTQ_adm1.shp", ///
        data(C:\ado\personal\map_coordinates\mtq1_database) coor(C:\ado\personal\map_coordinates\mtq1_coords) replace

** USE the converted database file
use C:\ado\personal\map_coordinates\mtq1_database, replace
tempfile mtq1_database
save `mtq1_database', replace
** Prepare adatabase file for merging with Mortality rates 
rename NAME_0 cid
rename NAME_1 district
gen sabbr = ISO
keep cid district sabbr _ID 
order cid district sabbr _ID
replace cid = "Martinique"
save C:\ado\personal\map_coordinates\mtq1_database_clean, replace
...
rename cid cid1
decode cid1, gen(cid)
merge m:m cid using "C:\ado\personal\map_coordinates\mtq1_database_clean"
drop if _merge==1
drop _merge
tempfile basemap
save `basemap', replace
...
** MTQ. MALE. CVD-DIABETES.
#delimit ;
spmap 	i using "C:\ado\personal\map_coordinates\mtq1_coords", moc(gs14) mfc(gs14)
		id(_ID) oc(gs13 gs13 gs13 gs13 gs13 gs13 )
		title("", size(7.5) pos(12) ring(0))
		fcolor(Blues2) clmethod(eqint) eirange(37 136) legstyle(3) ndf(gs10) ndo(gs13) 
		legend(off ring(0) position(5) bm(l=5 r=2 t=5) size(7) symy(7) symx(7)) 
		bgcolor(gs16)
		;
# delimit cr
...
* Shapefile from  http://www.gadm.org/country
shp2dta using "C:\ado\personal\shapefiles\caribbean\frenchguiana\GUF_adm1.shp", ///
        data(C:\ado\personal\map_coordinates\guf1_database) coor(C:\ado\personal\map_coordinates\guf1_coords) replace

** USE the converted database file
use C:\ado\personal\map_coordinates\guf1_database, replace
tempfile guf1_database
save `guf1_database', replace
** Prepare adatabase file for merging with Mortality rates 
rename NAME_0 cid
rename NAME_1 district
gen sabbr = ISO
keep cid district sabbr _ID 
order cid district sabbr _ID
replace cid = "French Guiana"
save C:\ado\personal\map_coordinates\guf1_database_clean, replace
...
rename cid cid1
decode cid1, gen(cid)
merge m:m cid using "C:\ado\personal\map_coordinates\guf1_database_clean"
drop if _merge==1
drop _merge
tempfile basemap
save `basemap', replace
...
** GUF. MALE. CVD-DIABETES.
#delimit ;
spmap 	i using "C:\ado\personal\map_coordinates\guf1_coords", moc(gs14) mfc(gs14)
		id(_ID) oc(gs13 gs13 gs13 gs13 gs13 gs13 )
		title("", size(7.5) pos(12) ring(0))
		fcolor(Blues2) clmethod(eqint) eirange(28 136) legstyle(3) ndf(gs10) ndo(gs13) 
		legend(off ring(0) position(5) bm(l=5 r=2 t=5) size(7) symy(7) symx(7)) 
		bgcolor(gs16)
		;
# delimit cr
...
* Shapefile from  http://www.gadm.org/country
shp2dta using "C:\ado\personal\shapefiles\caribbean\cuba\CUB_adm1.shp", ///
        data(C:\ado\personal\map_coordinates\cub1_database) coor(C:\ado\personal\map_coordinates\cub1_coords) replace

** USE the converted database file
use C:\ado\personal\map_coordinates\cub1_database, replace
tempfile cub1_database
save `cub1_database', replace
** Prepare adatabase file for merging with Mortality rates 
rename NAME_0 cid
rename NAME_1 district
gen sabbr = ISO
...
order cid district sabbr _ID
replace cid = " Cuba"
save C:\ado\personal\map_coordinates\cub1_database_clean, replace
...
rename cid cid1
decode cid1, gen(cid)
merge m:m cid using "C:\ado\personal\map_coordinates\cub1_database_clean"
drop if _merge==1
drop _merge
tempfile basemap
save `basemap', replace
...
** CUB. MALE. CVD-DIABETES.
#delimit ;
spmap 	i using "C:\ado\personal\map_coordinates\cub1_coords", moc(gs14) mfc(gs14)
		id(_ID) oc(gs13 gs13 gs13 gs13 gs13 gs13 )
		title("", size(7.5) pos(12) ring(0))
		fcolor(Blues2) clmethod(eqint) eirange(42 136) legstyle(3) ndf(gs10) ndo(gs13) 
		legend(off ring(0) position(5) bm(l=5 r=2 t=5) size(7) symy(7) symx(7)) 
...
* Shapefile from  http://www.gadm.org/country
shp2dta using "C:\ado\personal\shapefiles\caribbean\puertorico\PRI_adm1.shp", ///
        data(C:\ado\personal\map_coordinates\pri1_database) coor(C:\ado\personal\map_coordinates\pri1_coords) replace

** USE the converted database file
use C:\ado\personal\map_coordinates\pri1_database, replace
tempfile pri1_database
save `cub1_database', replace
** Prepare adatabase file for merging with Mortality rates 
rename NAME_0 cid
rename NAME_1 district
...
keep cid district sabbr _ID 
order cid district sabbr _ID
replace cid = "Puerto Rico"
save C:\ado\personal\map_coordinates\pri1_database_clean, replace
...
rename cid cid1
decode cid1, gen(cid)
merge m:m cid using "C:\ado\personal\map_coordinates\pri1_database_clean"
drop if _merge==1
drop _merge
tempfile basemap
save `basemap', replace
...
** CUB. MALE. CVD-DIABETES.
#delimit ;
spmap 	i using "C:\ado\personal\map_coordinates\pri1_coords", moc(gs14) mfc(gs14)
		id(_ID) oc(gs13 gs13 gs13 gs13 gs13 gs13 )
		title("", size(7.5) pos(12) ring(0))
		fcolor(Blues2) clmethod(eqint) eirange(42 136) legstyle(3) ndf(gs10) ndo(gs13) 
		legend(off ring(0) position(5) bm(l=5 r=2 t=5) size(7) symy(7) symx(7)) 
