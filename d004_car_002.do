...
use "data\result\car_001\carib_deaths_001", clear

** YEAR 2012 not required
drop if year==2012

** FULL COUNTRY GROUP (WITH MORTALITY DATA --> 1999-2001  and   2009-2011 
** This group ensures a FULL 10-year gap between first mortality year and last mortality year
** We lose TWO countries with insufficient mortality data --> Haiti and Jamaica
** Antigua		2010 		--> 2009 exists in DB, but has serious undercount
** Aruba			2025 
** Bahamas 		2030 
** Barbados		2040 
** Belize			2045 
...
** USVI			2455
gen group18 = 0
replace group18 = 1 if 	cid==2010 | cid==2025 |	cid==2030 | cid==2040 | cid==2045 |					///
						cid==2150 | cid==2170 | cid==2210 | cid==2230 | cid==2240 |	cid==2260 | 	///
						cid==2300 |	cid==2380 | cid==2400 | cid==2420 | cid==2430 | cid==2440


** Countries with 6 data years (1999-2001) and (2009-2011)
** 7 COUNTRIES with full 6 years of submitted data
** Aruba			2025 
** Belize			2045 
** Cuba 			2150 
** Dom Rep		2170
...
** St.Vincent		2420 
** Suriname		2430 
gen group6 = cid==2025 | cid==2045 | cid==2150 | cid==2170 | cid==2400 | cid==2420 | cid==2430

** Countries with 5 data years (1999-2001) and (2009-2011)
** 6 COUNTRIES with 5 years of submitted data
** Bahamas 		2030 
** Barbados		2040 
** Guadeloupe 	2240 
** Guyana 		2260 
...
** Puerto Rico 	2380 
** USVI			2455
gen group5 = cid==2030 | cid==2040 | cid==2260 | cid==2300 | cid==2380 | cid==2455


** Countries with 4 data years (1999-2001) and (2009-2011)
** 4 COUNTRIES with 4 years of submitted data
** Antigua		2010 		--> 2009 exists in DB, but has serious undercount
** Fr. Guiana		2210 
** Grenada		2230 
** Trinidad		2440 
gen group4 = cid==2010 | cid==2210 | cid==2230 | cid==2440


** Keep only the required years (1999-2001  AND  2009-2011)
** Also create an indicator to list the available years in each country
** File showing data availability held at --> C:\statistics\analysis\a000\15_who_md\versions\version04\data\availability\list_ctry_yrs25may2015.xls
** 1999		1
** 2000		2
** 2001		3
**
...
gen ykeep = 0
	...
	** Antigua **
	replace ykeep = 1 if cid==2010 & (year==1999|year==2000|year==2001|year==2008|year==2012)
	** Aruba
	replace ykeep = 1 if cid==2025 & (year==1999|year==2000|year==2001|year==2009|year==2010|year==2011)
	** Bahamas
	replace ykeep = 1 if cid==2030 & (year==1999|year==2000|year==2001|year==2009|year==2010|year==2011)
	** Barbados
	replace ykeep = 1 if cid==2040 & (year==1999|year==2000|year==2001|year==2009|year==2010|year==2011)
	** Belize
	replace ykeep = 1 if cid==2045 & (year==1999|year==2000|year==2001|year==2009|year==2010|year==2011)
	** Cuba
	replace ykeep = 1 if cid==2150 & (year==1999|year==2000|year==2001|year==2009|year==2010|year==2011)
	** Dom.Rep 
	replace ykeep = 1 if cid==2170 & (year==1999|year==2000|year==2001|year==2009|year==2010|year==2011)
	** French Guiana
	replace ykeep = 1 if cid==2210 & (year==1999|year==2000|year==2001|year==2009|year==2010|year==2011)
	** Grenada
	replace ykeep = 1 if cid==2230 & (year==1999|year==2000|year==2001|year==2009|year==2010|year==2011)
	** Guadeloupe
	replace ykeep = 1 if cid==2240 & (year==1999|year==2000|year==2001|year==2009|year==2010|year==2011)
	** Guyana
	replace ykeep = 1 if cid==2260 & (year==1999|year==2000|year==2001|year==2009|year==2010|year==2011)
	** Haiti 			--> DO NOT INCLUDE (no end of decade data)
	** Jamaica 		--> DO NOT INCLUDE (no end of decade data)
	** Martinique
	replace ykeep = 1 if cid==2300 & (year==1999|year==2000|year==2001|year==2009|year==2010|year==2011)
	** Puerto Rico
	replace ykeep = 1 if cid==2380 & (year==1999|year==2000|year==2001|year==2009|year==2010|year==2011)
	* St.Lucia
	replace ykeep = 1 if cid==2400 & (year==1999|year==2000|year==2001|year==2009|year==2010|year==2011)
	** St.Vincent
	replace ykeep = 1 if cid==2420 & (year==1999|year==2000|year==2001|year==2009|year==2010|year==2011)
	** Suriname
	replace ykeep = 1 if cid==2430 & (year==1999|year==2000|year==2001|year==2009|year==2010|year==2011)
	** Trinidad
	replace ykeep = 1 if cid==2440 & (year==1999|year==2000|year==2001|year==2009|year==2010|year==2011)
	** USVI 
	replace ykeep = 1 if cid==2455 & (year==1999|year==2000|year==2001|year==2009|year==2010|year==2011)
	** We keep all years for now
	** keep if ykeep==1


** Create indicator for year blocks
gen decade = .
** 1999-2001
replace decade = 1 if year==1999|year==2000|year==2001
** 2009-2011 (2008 included to accomodate Antigua data errors in 2009)
replace decade = 2 if year==2009|year==2010|year==2011
...
collapse (sum) deaths, by(cid sex decade year age11 cod md)


*****************************************************************
** Merge Annual Death and Population data
** carib_pop_004 --> comes from DO FILE: d012_car_pop_004.do
merge m:1 cid year sex age11 using "data\carib_pop_004"
*****************************************************************
...
save "data\result\car_002\car_deaths_002_a", replace
...
**		qp3		UNKNOWN AGE/SEX
*****************************************************************
use "data\result\car_002\car_deaths_002_a", clear
...
*****************************************************************
use `adjustment'
merge 1:m cid year using "data\result\car_002\car_deaths_002_a"
...
order cid year sex age11 cod decade pop poptot deaths qp1 qp2 qp3
...
** Save the final combined deaths + population dataset
save "data\result\car_002\car_deaths_002_aq", replace
****************************************************************
...
preserve
		...
		** Save the file ready for analysis
		order cid decade age11 deaths pop count prop  
		sort cid decade age11
		save "data\result\car_002\carib_cod`var'_a", replace
restore
}
...
use "data\result\car_002\car_deaths_002_aq", clear
...
preserve
		...
		** Save the file ready for analysis
		order cid decade age11 deaths pop count prop  
		sort cid decade age11
		save "data\result\car_002\carib_cod`var'_aq", replace
restore
}
