...
log using logfiles\d001_us1999_001_64, replace

**  GENERAL DO-FILE COMMENTS
**  program:      d001_us1999_001_64.do
...
** BY RACE (x2), YEAR (x15), GENDER (x3) == 90 ROWS 
** TWENTY ROWS FOR USA VALUE (1 row per year, for black and white separately)
** ************************************************************************************************
insheet using "C:\statistics\analysis\a054\versions\version05\data\input\wonder_2015\usa_level`folder1'\wonder`m'_usa_race_20150823_64.txt", tab clear
...
** USA: YEAR-GENDER
** BY YEAR (x15), GENDER (x3) == 45 ROWS
** ************************************************************************************************
insheet using "C:\statistics\analysis\a054\versions\version05\data\input\wonder_2015\usa_level`folder1'\wonder`m'_usa_20150823_64.txt", tab clear
...
** BY STATE (x51), RACE (x2), YEAR (x15), GENDER (x2) == 3060 ROWS 
** STATE_LEVEL DATA (WOMEN AND MEN ONLY)
** ************************************************************************************************
insheet using "C:\statistics\analysis\a054\versions\version05\data\input\wonder_2015\state_level`folder1'\wonder`m'_state_race_20150823_64.txt", tab clear

** Keep deaths from 2013 and earlier
keep if year<=2013
cap drop yearcode
cap drop oftotaldeaths
drop notes 
...
** STATE: RACE-YEAR
** BY STATE (x51), RACE (x2), YEAR (x15), GENDER (x1) == 1530 ROWS 
** STATE_LEVEL DATA (WOMEN AND MEN COMBINED - BOTH)
** ************************************************************************************************
insheet using "C:\statistics\analysis\a054\versions\version05\data\input\wonder_2015\state_level`folder1'\wonder`m'_state_race_both_20150823_64.txt", tab clear
...
** STATE: YEAR-GENDER
** BY STATE (x51), RACE (x1), YEAR (x15), GENDER (x3) == 2295 ROWS 
** STATE_LEVEL DATA (ALL RACES. WOMEN & MEN SEPARATED. WOMEN AND MEN COMBINED)
** ************************************************************************************************
insheet using "C:\statistics\analysis\a054\versions\version05\data\input\wonder_2015\state_level`folder1'\wonder`m'_state_20150823_64.txt", tab clear
...
foreach x of numlist 4 3 5 6 7 {
