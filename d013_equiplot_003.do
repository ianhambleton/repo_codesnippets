...
** Keep Caribbean data
**	-->	(N=10, English-speaking, 0-74, age adjusted, dataset 24)
**	-->	(N=8, non-English-speaking, 0-74, age adjusted, dataset 30)
** Keep US data 
...
preserve
	...
	** Re-order non-English Caribbean and US AA
	...
	gr twoway 
		...
		/// Minimum points
		(sc ind2 mr_lo, 				msize(9) m(o) mlc(gs0) mfc("255 255 191") mlw(0.1))
		/// Maximum points
		(sc ind2 mr_hi , 				msize(9) m(o) mlc(gs0) mfc("253 174 97") mlw(0.1))
		/// Caribbean average
		(sc ind2 carib ,			 	msize(7) m(o) mlc(gs10) mfc(gs10) mlw(0.1))
		///US averages
		(sc ind2 us if dataset>=100, 	msize(7) m(o) mlc(gs10) mfc(gs10) mlw(0.1))
		,
			...
			xtitle("`title1'", size(5) margin(l=2 r=2 t=5 b=2)) 
			xmtick(`tick2')
			
			ylab(	1 "Car ES" 4 "aa US" 7 "Car nES" 10 " w US"  
					,
			labs(5) tstyle(major_notick) nogrid glc(gs16) angle(0) format(%9.0f))
...
preserve
	...
	** 2009-2011
	...
	gr twoway 
		...
		(sc ind2 mr_lo if decade==1, 				msize(9) m(o) mlc("9 6 5 16") mfc("9 6 5 16") mlw(0.1))
		(sc ind2 mr_hi if decade==1 , 				msize(9) m(o) mlc("9 6 5 16") mfc("9 6 5 16") mlw(0.1))
		(sc ind2 carib if decade==1 ,			 	msize(7) m(o) mlc("9 6 5 16") mfc("9 6 5 16") mlw(0.1))
		(sc ind2 us  if decade==1 & dataset>=100, 	msize(7) m(o) mlc("9 6 5 16") mfc("9 6 5 16") mlw(0.1))

		/// 1999-2001
		(rspike mr_lo mr_hi ind2 if decade==2, 		hor lc(gs10) lw(0.35))
		(sc ind2 mr_lo if decade==2, 				msize(9) m(o) mlc(gs0) mfc("255 255 191") mlw(0.1))
		(sc ind2 mr_hi if decade==2 , 				msize(9) m(o) mlc(gs0) mfc("253 174 97") mlw(0.1))
		(sc ind2 carib if decade==2 ,			 	msize(7) m(o) mlc(gs10) mfc(gs10) mlw(0.1))
		(sc ind2 us  if decade==2 & dataset>=100, 	msize(7) m(o) mlc(gs10) mfc(gs10) mlw(0.1))
